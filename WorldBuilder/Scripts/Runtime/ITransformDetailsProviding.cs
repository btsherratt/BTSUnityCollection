...
namespace SKFX.WorldBuilder {
    public interface ITransformDetailsProviding {
        ...
        long GenerateDetails(TransformDetails[] transformDetailsOut, long startIndex, float objectRadius, float groundAngleMultiplier, float maxAngle, int snapLayerMask = 0);
