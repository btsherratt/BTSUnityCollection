...
[Serializable]
public class WaitClip : PlayableAsset {
    ...
    public override Playable CreatePlayable(PlayableGraph graph, GameObject owner) {
        ScriptPlayable<WaitPlayable> playable = ScriptPlayable<WaitPlayable>.Create(graph);
        WaitPlayable waitPlayable = playable.GetBehaviour();
